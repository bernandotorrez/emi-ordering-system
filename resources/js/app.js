...
//require('../../public/assets/js/custom')

document.addEventListener('livewire:load', function () {

    var PerfectScrollbar = require('../../public/plugins/perfect-scrollbar/perfect-scrollbar.min')

    var urlPath = window.location.pathname

    if (urlPath != '/login' && urlPath != '/register' && urlPath != '/logout') {
        var App = function () {
            var MediaSize = {
                xl: 1200,
                lg: 992,
