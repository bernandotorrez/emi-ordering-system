                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                ...
                                <div class="form-group mb-4">
                                    <label for="sub_sub_child_position">Sub Sub Child Position</label>
                                    <input type="text" class="form-control" id="sub_sub_child_position" maxlength="10"
                                        placeholder="Example : 1" wire:model.lazy="bind.sub_sub_child_position">
                                    @error('bind.sub_sub_child_position') <span class="error">{{ $message }}</span>
                                    @enderror
                                </div>

                                <div class="form-group mb-4">
                                    <label for="nama_sub_sub_child_menu">Nama Sub Sub Child Menu</label>
                                    <input type="text" class="form-control" id="nama_sub_sub_child_menu" maxlength="100"
                                        placeholder="Example : Sales Order" wire:model.lazy="bind.nama_sub_sub_child_menu">
                                    @error('bind.nama_sub_sub_child_menu') <span class="error">{{ $message }}</span>
                                    @enderror
                                </div>
            ...
            <div class="table-responsive mt-4">
                ...
                <table class="table table-striped table-bordered" id="users-table">
                    <thead>
                        ...
                        <th wire:click="sortBy('id_sub_child_menu')">
                            <a href="javascript:void(0);">Sub Child Menu
                                @include('livewire.datatable-icon', ['field' => 'id_sub_child_menu'])
                            </a>
                        </th>
                        <th wire:click="sortBy('sub_sub_child_position')">
                            <a href="javascript:void(0);">Sub Sub Child Position
                                @include('livewire.datatable-icon', ['field' => 'sub_sub_child_position'])
                            </a>
                        </th>
                        <th wire:click="sortBy('nama_sub_sub_child_menu')">
                            <a href="javascript:void(0);">Nama Sub Sub Child Menu
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->subChildMenu->nama_sub_child_menu }}</td>
                            <td>{{ $data->sub_sub_child_position }}</td>
                ...
                <div class="d-flex justify-content-center">
                    {{ $dataSubSubChildMenu->links('livewire.pagination-links') }}
                </div>
