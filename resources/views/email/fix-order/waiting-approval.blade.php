...
<body>
    ...
    <table class="detail_pp">
        ...
        <tr>
            <th width="100%" colspan="4" style="text-align: center; background-color: #28ba62;"> Status Progress : Waiting Approval </th>
        </tr>
        ...
        <tr>
            ...
            <th width="15%"> Date Send Approval </th>
            <td width="35%">{{date("d-M-Y H:i:s", strtotime($dataMaster->date_send_approval))}}</td>
        ...
        <tr>
            ...
            <td width="35%">{{$dataMaster->grand_total_qty}}</td>
        </tr>
