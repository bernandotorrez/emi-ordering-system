...
<body>
    ...
    <table class="detail_pp">
        ...
        <tr>
            <th width="100%" colspan="4" style="text-align: center; background-color: #28ba62;"> Status Progress : Approved </th>
        </tr>
        ...
        <tr>
            ...
            <th width="15%"> Date Approve </th>
            <td width="35%">{{date("d-M-Y H:i:s", strtotime($dataMaster->date_approval))}}</td>
