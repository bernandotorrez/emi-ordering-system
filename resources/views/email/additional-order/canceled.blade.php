...
<body>
    ...
    <table class="detail_pp">
        ...
        <tr>
            <th width="100%" colspan="4" style="text-align: center; background-color: #e7515a;"> Status Progress : Canceled by {{$by}} ( {{session()->get('user')['nama_user']}} )  </th>
        </tr>
        ...
        <tr>
            <th width="15%"> Date Cancel </th>
            <td width="35%">{{date("d-M-Y H:i:s", strtotime($dataMaster->date_cancel))}}</td>
        ...
        <tr>
            <th width="15%"> Remarks Cancel </th>
            <td width="85%" colspan="3">{{$dataMaster->remark_cancel}}</td>
        </tr>
