...
<body>
    ...
    <table class="detail_pp">
        ...
        <tr>
            <th width="100%" colspan="4" style="text-align: center; background-color: #28ba62;"> Status Progress : Allocated </th>
        </tr>
        ...
        <tr>
            <th width="15%"> Date Allocation </th>
            <td width="35%">{{date("d-M-Y H:i:s", strtotime($dataMaster->date_allocation_atpm))}}</td>
