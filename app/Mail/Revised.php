...
class Revised extends Mailable
{
    ...
    public function build(
        ...
        if($this->order == 'A') {
            ...
            return $this->subject('No Additional Order Dealer : '.$dataMaster->no_order_dealer.' Revised!')
            ->view('email.additional-order.revised', [
            ...
            return $this->subject('No Fix Order Dealer : '.$dataMaster->no_order_dealer.' Revised!')
            ->view('email.fix-order.revised', [
                'dataMaster' => $dataMaster,
                'dataDetail' => $dataDetail
            ]);
        }
