...
class Approved extends Mailable
{
    ...
    public function build(
        ...
        if($this->order == 'A') {
            ...
            return $this->subject('No Additional Order Dealer : '.$dataMaster->no_order_dealer.' Approved!')
            ->view('email.additional-order.approved', [
            ...
            return $this->subject('No Fix Order Dealer : '.$dataMaster->no_order_dealer.' Approved!')
            ->view('email.fix-order.approved', [
                'dataMaster' => $dataMaster,
                'dataDetail' => $dataDetail
            ]);
        }
