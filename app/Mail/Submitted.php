...
class Submitted extends Mailable
{
    ...
    public function build(
        ...
        if($this->order == 'A') {
            ...
            return $this->subject('No Additional Order Dealer : '.$dataMaster->no_order_dealer.' Submitted!')
            ->view('email.additional-order.submitted', [
            ...
            return $this->subject('No Fix Order Dealer : '.$dataMaster->no_order_dealer.' Submitted!')
            ->view('email.fix-order.submitted', [
                'dataMaster' => $dataMaster,
                'dataDetail' => $dataDetail
            ]);
        }
