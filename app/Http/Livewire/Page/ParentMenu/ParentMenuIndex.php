...
class ParentMenuIndex extends Component
{
    ...
    protected $rules = [
        ...
        'bind.url' => 'required|min:3',
    ];

    protected $messages = [
        'bind.parent_position.required' => 'The Parent Posiiton Cant be Empty!',
        'bind.parent_position.numeric' => 'The Parent Position must be Numeric',
        'bind.parent_position.min' => 'The Parent Posiiton must be at least :min Characters',
